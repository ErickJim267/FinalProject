...
Revision ID: 38ee25ca93dd
Revises: 
Create Date: 2021-04-27 07:58:45.001764
...
def upgrade():
    ...
    sa.Column('about_me_short', sa.String(length=100), nullable=False),
    sa.Column('about_me_long', sa.Text(), nullable=False),
